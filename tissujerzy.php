...
$pdo = maConnexion();
$sql = "SELECT * FROM jerzy";
$stmt = $pdo->prepare($sql);
$stmt->execute();
$tissujerzyData = $stmt->fetchAll(PDO::FETCH_ASSOC);
?>
...
<body>
    ...
    <section id="product1" class="section p1">
        <div class="pro-container">
            <?php foreach ($tissujerzyData as $tissu) { ?>
                <div class="pro">
                    ...
                    <a href="detail_jerzy.php?id=<?php echo $tissu['id']; ?>" class="btn btn-primary">Voir Détails</a>

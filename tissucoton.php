...
$pdo = maConnexion();
$sql = "SELECT * FROM tissucoton";
$stmt = $pdo->prepare($sql);
$stmt->execute();
$tissucotonData = $stmt->fetchAll(PDO::FETCH_ASSOC);
?>
...
<body>
    ...
    <section id="product1" class="section p1">
        <div class="pro-container">
            <?php foreach ($tissucotonData as $tissu) { ?>
                <div class="pro">
                    ...
                    <a href="detail_produit.php?id=<?php echo $tissu['id']; ?>" class="btn btn-primary">Voir Détails</a>
